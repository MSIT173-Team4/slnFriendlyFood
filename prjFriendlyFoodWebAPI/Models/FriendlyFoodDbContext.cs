...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=FriendlyFoodDb;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tApplySt__D9F8227C7B6ECE1F");
        ...
        {
            entity.HasKey(e => new { e.FConversationId, e.FUserId }).HasName("PK__tConvers__8DB173361F8F7843");
            ...
            entity.HasOne(d => d.FUser).WithMany(p => p.TConversationMembers)
                .HasForeignKey(d => d.FUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__tConversa__fUser__56B3DD81");
        });
        ...
        modelBuilder.Entity<TFoodMapPlaceCategory>(entity =>
        {
            ...
            entity.Property(e => e.FDescription)
                .HasMaxLength(200)
                .HasColumnName("fDescription");
            entity.Property(e => e.FGooglePlaceType)
                .HasMaxLength(50)
                .HasColumnName("fGooglePlaceType");
            entity.Property(e => e.FUpdatedTime)
                .HasPrecision(0)
                .HasColumnName("fUpdatedTime");
        });
        ...
        modelBuilder.Entity<TFoodMapTripPlace>(entity =>
        {
            ...
            entity.Property(e => e.FTripId).HasColumnName("fTripID");
            entity.Property(e => e.FVisitTime)
                .HasPrecision(0)
        ...
        {
            entity.HasKey(e => e.FPostBlockId).HasName("PK__tPostBlo__92BD60D69404B92A");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tSeller__D9F8227CB01567B5");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tStatus__D9F8227CD2E45592");
        ...
        modelBuilder.Entity<TUser>(entity =>
        {
            ...
            entity.HasIndex(e => e.FUsername, "UQ__tmp_ms_x__A8F6564AC1E5B5D9").IsUnique();
