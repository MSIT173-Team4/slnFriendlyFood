...
public partial class FriendlyFoodDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tApply__D9F8227C7E5243B3");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tApplySt__D9F8227CBFADD8AD");
        ...
        {
            entity.HasKey(e => new { e.FConversationId, e.FUserId }).HasName("PK__tConvers__8DB17336E1B7002E");
            ...
            entity.HasOne(d => d.FConversation).WithMany(p => p.TConversationMembers)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__tConversa__fConv__5AB9788F");

            entity.HasOne(d => d.FUser).WithMany(p => p.TConversationMembers)
                .HasForeignKey(d => d.FUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__tConversa__fUser__5BAD9CC8");
        });
        ...
        {
            entity.HasKey(e => e.FPostBlockId).HasName("PK__tPostBlo__92BD60D66BC8DF3E");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tSeller__D9F8227C3A94E6AC");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tStatus__D9F8227CAB0CF704");
        ...
        modelBuilder.Entity<TUser>(entity =>
        {
            ...
            entity.HasIndex(e => e.FUsername, "UQ__tUser__A8F6564A163A3D89").IsUnique();
