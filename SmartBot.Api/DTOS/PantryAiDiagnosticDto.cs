...
public sealed class PantryAiDiagnosticDto
{
    ...
    public string SuggestedUnit { get; set; } = "份";
    public string StorageTip { get; set; } = string.Empty;
    public int EstimatedDays { get; set; } = 7;
}

public sealed class PantryAiDiagnosticBatchDto
{
    public IReadOnlyCollection<PantryAiDiagnosticDto> Ingredients { get; set; } = [];
}
